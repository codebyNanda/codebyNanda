...
Desenvolvedora **Backend** com foco em **segurança**, APIs e boas práticas de desenvolvimento.
Já atuei como **Full Stack**, o que me deu uma base de frontend, mas atualmente concentro minha atuação e estudos em **backend e segurança da informação**.

---

## 🚀 Sobre mim
- 💻 Experiência com desenvolvimento backend e consumo/criação de APIs
- 🔐 Interesse e atuação em **segurança**, validação de dados, controle de acesso e boas práticas
- 🧠 Me interesso por entender como as aplicações realmente funcionam, explorando fluxos, limites e comportamentos que não ficam evidentes à primeira vista.
- 📚 Sempre estudando e evoluindo tecnicamente
...
- Projetos backend focados em lógica, regras de negócio e persistência de dados
- APIs simples para estudo e prática
- Projetos frontend desenvolvidos anteriormente, que mostram minha base como Full Stack

👉 Os repositórios mais relevantes estão fixados abaixo.
...
<div> 
  ...
  <a href="https://www.linkedin.com/in/ananda-santos-ferreira/" target="_blank"><img src="https://img.shields.io/badge/-LinkedIn-%230077B5?style=for-the-badge&logo=linkedin&logoColor=white" target="_blank"></a>  
</div>
